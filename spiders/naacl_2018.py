...
#//*[@id="n18-2"]/p[2]/span[2]/a
#//*[@id="abstract-N18-2001"]/div
class Naacl2018Spider(scrapy.Spider):
    name = 'naacl_2018'
    allowed_domains = ['']
    start_urls = ['file:///Users/sauron/Desktop/Code/crawler/acl-abstract/naacl/2018.html']

    def parse(self, response):
        stock_item = StockSpiderItem()
        conferences_name_list = ["n18-1", "n18-2", "n18-3", "n18-4", "n18-5", "n18-6", "w18-05", "w18-06", "w18-07",
                                 "w18-08",
                                 "w18-09", "w18-10", "w18-11", "w18-12", "w18-13", "w18-14", "w18-15", "w18-16",
                                 "w18-17"]
        conferences_number_list = [206,126,28,21,21,7,51,22,12,3,19,6,17,11,6,9,8,6,9]
